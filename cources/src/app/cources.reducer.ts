...
import { fromEntityActions } from "./cources.action";
import { CourceItem } from "./cource-item";

export const ENTITY_FEATURE_KEY = "entity";

export interface State extends EntityState<CourceItem> {
  loaded: boolean;
  error?: Error | any;
}

export const adapter: EntityAdapter<CourceItem> = createEntityAdapter<CourceItem>({
